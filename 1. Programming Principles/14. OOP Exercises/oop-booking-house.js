...
(function () {
    ...
    Player.prototype.getPlayerData = function () {
        return `${serbia.name}, ${playerOne.getAmount()} eur, ${stefan.getFullName()}, ${stefan.getPersonAge()} years`
    }
    ...
    const personAddress = new Address(serbia.name, 'Arandjelovac', 34300, 'Gavrila Principa', 17);
    const personTwoAddress = new Address(usa.name, 'New York', 10022, 'Fifth Avenue', 721)
